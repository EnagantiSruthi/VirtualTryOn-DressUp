...
garm_list = os.listdir(os.path.join(images_path, "cloth"))
garm_list_path = [os.path.join(images_path, "cloth", garm) for garm in garm_list]

human_list = os.listdir(os.path.join(images_path, "human"))
human_list_path = [os.path.join(images_path, "human", human) for human in human_list]
...
image_blocks = gr.Blocks(css="""
    #try-btn {
        background: linear-gradient(90deg, #ff4d6d, #ff9f43, #ffd60a);
        color: black;
        ...
        box-shadow: 0px 0px 15px rgba(255, 200, 100, 0.6);
    }
    #try-btn:hover {
        transform: scale(1.1);
        background: linear-gradient(90deg, #ffd60a, #ff9f43, #ff4d6d);
        box-shadow: 0px 0px 25px rgba(255, 255, 150, 0.9);
...
with image_blocks as demo:
    gr.HTML(
        ...
        <center>
            ...
            font-weight: 300;
            letter-spacing: 3px;
            background: linear-gradient(90deg, #ff4d6d, #ff9f43, #ffd60a, #6bcBef, #9d4edd);
    ...
    with gr.Row():
        try_button = gr.Button(value=" Try-On ", elem_id="try-btn")
